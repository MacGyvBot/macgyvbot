...
class CommandInputNode(Node):
    ...
    def _robot_status_message(self, state, target_label, raw_message, reason):
        ...
        templates = {
            ...
            'return_floor_detected': '바닥에 있는 반납 공구를 집는 중입니다.',
            'picking_return_floor_tool': '바닥에 있는 반납 공구를 집는 중입니다.',
    ...
    def _robot_panel_status(self, state, message):
        labels = {
            ...
            'return_floor_detected': '바닥 공구 감지',
            'picking_return_floor_tool': '바닥 공구 파지',
    ...
    def _robot_stage_text(self, state, message):
        stage_labels = {
            ...
            'return_floor_detected': '바닥 공구 감지됨',
            'picking_return_floor_tool': '바닥 공구 잡는 중',
