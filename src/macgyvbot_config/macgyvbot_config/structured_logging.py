...
PIPE_LABELS = {
    ...
    "sam_yaw_service": "sam_yaw_service",
...
MESSAGE_TRANSLATIONS = {
    ...
    "SAM yaw service ready": "SAM yaw 서비스 준비 완료",
    "SAM yaw service request received": "SAM yaw 서비스 요청 수신",
    "SAM yaw service image conversion failed": "SAM yaw 서비스 image 변환 실패",
    "SAM yaw service request bbox is invalid": "SAM yaw 서비스 bbox 오류",
    "SAM yaw service mask generation failed": "SAM yaw 서비스 mask 생성 실패",
    "SAM yaw service PCA yaw failed": "SAM yaw 서비스 PCA yaw 계산 실패",
    "SAM yaw service response ready": "SAM yaw 서비스 응답 준비 완료",
    "SAM yaw service preload started": "SAM yaw 서비스 preload 시작",
    "SAM yaw service preload completed": "SAM yaw 서비스 preload 완료",
    "SAM yaw service disabled": "SAM yaw 서비스 비활성화",
    "SAM yaw service init failed": "SAM yaw 서비스 초기화 실패",
    "SAM yaw service request created": "SAM yaw 서비스 요청 생성",
    "SAM yaw service unavailable within timeout": "SAM yaw 서비스를 제한 시간 안에 사용할 수 없습니다",
    "SAM yaw service request sent": "SAM yaw 서비스 요청 전송",
    "SAM yaw service request interrupted while waiting for response": "SAM yaw 서비스 응답 대기 중 요청 중단",
    "SAM yaw service response timeout": "SAM yaw 서비스 응답 시간 초과",
    "SAM yaw service response received": "SAM yaw 서비스 응답 수신",
    "SAM yaw service future failed": "SAM yaw 서비스 future 실패",
    "SAM yaw service returned no response object": "SAM yaw 서비스가 응답 객체를 반환하지 않았습니다",
    "SAM yaw service reported failure": "SAM yaw 서비스 실패 응답 수신",
    "SAM yaw service failed at VLM observe pose": "VLM 관찰 자세에서 SAM yaw 서비스 실패",
    "SAM yaw service result saved": "SAM yaw 서비스 결과 저장 완료",
