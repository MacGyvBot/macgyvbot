...
def build_prompt(label, target_label, image_size):
    ...
    return (
        ...
        "- The current gripper pose already grasps a tool aligned with the image y-axis correctly.\n"
        "- If the graspable part is vertical in the image, yaw_deg must be near 0.\n"
        "- A nearly vertical graspable part should have a small yaw near 0.\n"
        "- Estimate the real continuous tilt of the graspable part relative to the image y-axis.\n"
        ...
        "- If the graspable part is horizontal, yaw_deg should be near 90 or -90.\n"
