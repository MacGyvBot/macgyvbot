...
from macgyvbot.command_input.input_mapping.command_llm_parser import (
    CommandLlmParser,
)
from macgyvbot.command_input.stt.speech_to_text import SpeechToTextService
from macgyvbot.command_input.tts import TtsService
