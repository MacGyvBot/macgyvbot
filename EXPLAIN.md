...
- `macgyvbot/util/macgyvbot_main/task_pipeline/task_pipeline.py`
  ...
  - gripper close 뒤 동작이 끝난 상태에서 OnRobot RG의 `grip detected`와 폭이 연속 확인될 때 `grasp_success` 또는 `robot_grasp_failed`를 발행합니다.
